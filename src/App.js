            ...
            <div id="content">
              ...
              <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  ...
                  >
                    <i class="fas fa-download fa-sm text-white-50" /> Generate
                    Report
                  </a>
                </div>
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                          <span class="mr-2">
                            <i class="fas fa-circle text-primary" /> Direct
                          </span>
                          <span class="mr-2">
                            <i class="fas fa-circle text-success" /> Social
                          </span>
                          <span class="mr-2">
                            <i class="fas fa-circle text-info" /> Referral
                          </span>
                        </div>
                      </div>
                    </div>
